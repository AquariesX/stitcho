    ...
    return (
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="p-6 border-b border-gray-100 space-y-4">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">Manage valid accounts and their status</p>
                    </div>
                    <div className="bg-blue-50 text-blue-700 px-4 py-2 rounded-lg text-sm font-medium">
                        Total Users: <span className="font-bold text-lg ml-1">{initialUsers.length}</span>
                    </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-2">
                    ...
                    <select
                        className="px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-gray-700 font-medium"
                        value={roleFilter}
            ...
            <div className="px-6 py-4 border-t border-gray-100 bg-gray-50 text-sm text-gray-500 flex justify-between items-center">
                <span>Showing {filteredUsers.length} of {initialUsers.length} users</span>
            </div>
        </div>
    );
}
