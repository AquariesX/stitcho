...
import {
    CheckCircle, Trash2, Search, Loader2, ChevronDown, Check
} from "lucide-react";
import { 
...
export default function CompletedOrdersPage() {
    ...
    // FILTER SPECIFIC: Only Finished states
    const relevantOrders = orders.filter(o => o.status === "READY" || o.status === "DELIVERED" || o.status === "COMPLETED");
        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mt-1">Finished products ready for handover or completely delivered</p>
                </div>
            ...
            {loading ? (
                ...
                >
                    ...
                    <h3 className="text-xl font-bold dark:text-white text-gray-800">No Completed Records</h3>
                    <p className="text-gray-500 dark:text-gray-400 mt-2 text-center max-w-md">
                        {searchTerm ? "No records match your search." : "There are currently no finished projects available in your history archive."}
                    </p>
                </motion.div>
            ) : (
