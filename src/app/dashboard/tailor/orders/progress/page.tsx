...
import {
    Scissors, Trash2, Search, Loader2, ChevronDown, Check
} from "lucide-react";
import { 
...
export default function InProgressOrdersPage() {
    ...
    // FILTER SPECIFIC: Only In-Progress states
    const relevantOrders = orders.filter(o => o.status === "CUTTING" || o.status === "STITCHING" || o.status === "PROCESSING");
        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mt-1">Items currently being crafted in the workshop</p>
                </div>
            ...
            {loading ? (
                ...
                >
                    <div className="w-20 h-20 bg-gray-50 dark:bg-[#111c21] rounded-full flex items-center justify-center mb-4">
                        <Scissors size={32} className="text-gray-300 dark:text-gray-600" />
                    </div>
                    <h3 className="text-xl font-bold dark:text-white text-gray-800">No Active Workshop Projects</h3>
                    <p className="text-gray-500 dark:text-gray-400 mt-2 text-center max-w-md">
                        {searchTerm ? "No projects match your search." : "No orders are currently in the cutting or stitching phase. Check pending."}
                    </p>
                </motion.div>
            ) : (
