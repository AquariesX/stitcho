...
import {
    ShoppingBag, Trash2, Edit3, Plus, 
    X, CheckCircle, Clock, Scissors,
    Search, Loader2, ChevronDown, Check
} from "lucide-react";
import { 
...
// Mapped status to colors and icons
...
export default function TailorOrdersPage() {
    ...
    // View Modal State (Optional future use)
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mt-1">Manage and track your tailoring pipeline</p>
                </div>
            ...
            {loading ? (
                ...
                >
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mt-2 text-center max-w-md">
                        {searchTerm ? "No orders match your search criteria." : "You do not have any active orders right now. When customers place orders matching your products, they will dynamically appear here."}
                    </p>
                </motion.div>
            ) : (
